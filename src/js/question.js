        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                if(result.success) {
                    ...
                    conf.answerEditor.validify(result.error, function(div) {
        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                if(result.success) {
                    ...
                    answerPanel.find(".delete-answer").validify(result.error);
                }
            },
            error: function() {
        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                if(result.success) {
                   ...
                   conf.deleteQuestionConfirm.validify(result.error);
                }
            },
            error: function() {
